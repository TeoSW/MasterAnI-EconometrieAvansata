...
📦 Sursă date: Kaggle – Retail Intelligence Fraud Detection Dataset
...
ModelROC-AUCAvg. PrecisionNoteLogit curat (toate var.)~0.76—McFadden R² ≈ 0.18Logit redus (p < 0.1)~0.76—Specificație parsimonioasăLogit cu flag-uri≫ 0.90—⚠️ Quasi-separation / leakageRandom Forest~0.812~0.803Recall fraudă ≈ 72.3%
...
⚙️ Instalare & Rulare
Cerințe
bashpip install pandas numpy matplotlib seaborn scikit-learn scipy statsmodels
Rulare
bashjupyter notebook main.ipynb

⚠️ Asigurați-vă că db.csv se află în același director cu main.ipynb.
Dataset disponibil pe Kaggle.
...
Show Image
Show Image
LibrărieUtilizarepandas / numpyManipulare și preprocesare datematplotlib / seabornVizualizări EDAstatsmodelsRegresie Logistică, diagnostice econometricescikit-learnRandom Forest, metrici de evaluare, split datescipyKDE, teste statistice (Jarque-Bera, Shapiro-Wilk)
